...
exports.filterIssuesBySeverity = void 0;
const core = __importStar(require("@actions/core"));
const filterIssuesBySeverity = ({ issues, severityFilter, }) => {
    ...
    core.info(`Filtering issues by severity: ${severityFilter.join(", ")}. Found ${filteredIssues.length} of ${issues.length} issues.`);
